      ...
      <el-tab-pane label="其他设置" name="password">
        ...
        >
          ...
          <el-form-item label="评论审核">
            <el-radio-group v-model="websiteConfigForm.isCommentAudit">
              <el-radio :label="0">关闭</el-radio>
              <el-radio :label="1">开启</el-radio>
            </el-radio-group>
          </el-form-item>
          <el-form-item label="留言审核">
            <el-radio-group v-model="websiteConfigForm.isMessageAudit">
              <el-radio :label="0">关闭</el-radio>
              <el-radio :label="1">开启</el-radio>
            </el-radio-group>
          </el-form-item>
          ...
          <el-row style="width: 600px" v-show="websiteConfigForm.isReward == 1">
            <el-col :md="12">
              <el-form-item label="微信收款码">
                ...
                >
                  <img
                    v-if="websiteConfigForm.weChatQRCode"
                    :src="websiteConfigForm.weChatQRCode"
                    class="avatar"
                  />
                  <i v-else class="el-icon-plus avatar-uploader-icon" />
                </el-upload>
...
export default {
  ...
  methods: {
    ...
    handleWeiXinSuccess(response) {
      this.websiteConfigForm.weChatQRCode = response.data;
    },
